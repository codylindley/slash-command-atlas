...
> Exits Autopilot and restores the session’s default permissions.
...
- [Interactive command view](https://codylindley.github.io/slash-command-atlas/#/vscode/exitAutopilot)
