...
> Generates tests for all, or only the selected, methods and functions.
...
- [GitHub Copilot Chat in JetBrains — `/tests`](../jetbrains/tests.md)
- [GitHub Copilot Chat in Visual Studio — `/tests`](../visualstudio/tests.md)
- [GitHub Copilot Chat in Xcode — `/tests`](../xcode/tests.md)
...
- [Interactive command view](https://codylindley.github.io/slash-command-atlas/#/vscode/tests)
