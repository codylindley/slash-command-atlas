...
The agent researches your request and proposes an approach for review before implementation.
...
- [Interactive command view](https://codylindley.github.io/slash-command-atlas/#/cli/plan)
