...
- [`/remote-env`](./remote-env.md)

## Also in other surfaces

- [Claude Desktop — Code tab — `/schedule`](../claude-app/schedule.md)
...
- [Interactive command view](https://codylindley.github.io/slash-command-atlas/#/claude-cli/schedule)
