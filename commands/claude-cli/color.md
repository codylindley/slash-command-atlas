...
- [Claude Desktop — Code tab — `/color`](../claude-app/color.md)
- [Claude Code on the web — `/color`](../claude-web/color.md)
...
- [Interactive command view](https://codylindley.github.io/slash-command-atlas/#/claude-cli/color)
